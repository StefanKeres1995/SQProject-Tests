...
public class Helper {
    ...
    public void waitForSomething(WebDriver driver, int timeOutInSeconds, int typeOfCondition, String string, String url) throws InterruptedException {
        ...
        switch(typeOfCondition){
            ...
            case HelperConstants.WaitCondition_SearchSourceComponentIndex:
                ...
                TestCase.fail("Timeout on waiting. - Search source component index" + counter);
                break;
            ...
            case HelperConstants.WaitCondition_NumberOfElementsMoreThan:
                ...
                TestCase.fail("Timeout on waiting. - Number of elements more than" + counter);
                break;
    ...
    public Image getImageFromURL(String urlToRead) {
        try {
            StringBuilder result = new StringBuilder();
            URL url = new URL(urlToRead);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            ...
            Image image = gson.fromJson(jsonStr, Image.class);
            return image;

        } catch (IOException e) {
            e.printStackTrace();
        }
        fail("Error getting the image");
        return null;
    }
