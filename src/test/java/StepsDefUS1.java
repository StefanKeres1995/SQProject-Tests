...
public class StepsDefUS1 {
    ...
    static {
        ...
        System.setProperty("webdriver.chrome.driver", "/var/lib/jenkins/plugins/chromedriver/WEB-INF/lib/chromedriver.jar");
        ...
        if (driver == null) {
            ...
            ChromeOptions options = new ChromeOptions();
            options.addArguments("--headless");
            options.setBinary("/var/lib/jenkins/plugins/chromedriver/WEB-INF/lib/chromedriver.jar");
